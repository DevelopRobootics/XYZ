    ...
    return (
        <footer className="bg-gray-900 border-t border-gray-700">
            <div className="mx-auto w-full max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 border-t border-gray-700 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-400 text-center md:text-left">
