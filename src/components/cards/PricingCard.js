...
export default function PricingCard({
    ...
    return (
        <div className="flex flex-col justify-between bg-gradient-to-br from-white to-gray-100 border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-8 text-gray-800">
            ...
            <div className="space-y-4">
                ...
                <p className="text-4xl font-bold">
                    ...
                    <span className="text-base font-medium text-gray-600">/mes</span>
                </p>
